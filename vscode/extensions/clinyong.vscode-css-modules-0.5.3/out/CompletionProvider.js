...
class CSSModuleCompletionProvider {
    ...
    provideCompletionItems(document, position) {
        return __awaiter(this, void 0, void 0, function* () {
            const currentLine = (0, utils_1.getCurrentLine)(document, position);
            ...
            const importModule = (0, path_1.findImportModule)(document.getText(), obj);
            const importPath = yield (0, path_1.resolveImportPath)(importModule, currentDir, yield (0, path_alias_1.getRealPathAlias)(this.pathAliasOptions, document));
            if (importPath === "") {
                return Promise.resolve([]);
            }
            const classNames = yield (0, utils_1.getAllClassNames)(importPath, field);
            return Promise.resolve(classNames.map((_class) => {
                let name = _class;
                if (this._classTransformer) {
                    name = this._classTransformer(name);
                }
                if ((0, utils_1.isKebabCaseClassName)(name)) {
                    return (0, utils_1.createBracketCompletionItem)(name, position);
                }
