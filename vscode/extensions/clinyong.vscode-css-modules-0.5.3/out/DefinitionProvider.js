...
function getClickInfoByKeyword(document, currentLine, position) {
    ...
    const importModule = (0, path_1.findImportModule)(document.getText(), keyword.obj);
...
function getClickInfo(document, currentLine, position) {
    const matches = (0, path_1.genImportRegExp)("(\\S+)").exec(currentLine);
...
class CSSModuleDefinitionProvider {
    ...
    provideDefinition(document, position, token) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const importPath = yield (0, path_1.resolveImportPath)(clickInfo.importModule, currentDir, yield (0, path_alias_1.getRealPathAlias)(this.pathAliasOptions, document));
            if (importPath === "") {
                return Promise.resolve(null);
            }
